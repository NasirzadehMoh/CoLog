...
class LogParser:
    ...
    def outputResult(self, logClustL):
        ...
        log_messages = list(self.df_log['Content'].unique())
        return log_messages
    ...
    def parse(self, logName):
        ...
        for idx, line in self.df_log.iterrows():
            ...
            #     print('Processed {0:.1f}% of log lines.'.format(count * 100.0 / len(self.df_log)), end='')
            #     print('\r', end='')
        ...
        log_messages = self.outputResult(logCluL)
        # print('{} file parsing done. [Time taken: {!s}]'.format(self.logName, datetime.now() - start_time))
        return log_messages
